      ...
      >
        ...
        >
          ...
          <div className="p-6 sm:p-8 overflow-y-auto space-y-8">
            {/* Main Visual */}
            <div className="relative group rounded-xl overflow-hidden bg-neutral-950 border border-neutral-800/80 cursor-pointer">
              <ImageWithLoading
                src={project.image}
                alt={project.title}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {project.gallery.slice(1).map((imgUrl, i) => (
                    <div
                      key={i}
                      className="rounded-lg overflow-hidden border border-neutral-800 bg-neutral-950 cursor-pointer group"
