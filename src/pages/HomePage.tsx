...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <section className="relative pt-36 pb-24 sm:pt-44 sm:pb-32 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="space-y-8 max-w-4xl">
          {/* Availability pill */}
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full border border-neutral-800 dark:border-neutral-800 light:border-neutral-300 text-xs text-neutral-300 dark:text-neutral-300 light:text-neutral-700 bg-neutral-900/60 dark:bg-neutral-900/60 light:bg-neutral-100">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>{settings.statusText || 'Available for freelance commissions & retainers'}</span>
          </div>

          {/* Large Editorial Headline */}
          <h1 className="editorial-hero-title font-semibold tracking-tight text-neutral-100 dark:text-neutral-100 light:text-neutral-950">
            Ash Wickramasinghe
          </h1>

          {/* Subtitle / Focus */}
          <p className="text-xl sm:text-2xl text-neutral-400 dark:text-neutral-400 light:text-neutral-600 font-light tracking-tight max-w-3xl leading-relaxed">
          ...
          <div className="pt-4 flex flex-wrap items-center gap-4">
            <Link
              to="/projects"
              className="inline-flex items-center gap-2 px-6 py-3.5 text-xs uppercase tracking-widest font-medium rounded-full bg-neutral-100 text-neutral-950 hover:opacity-90 transition-all shadow-sm"
            >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-6 py-3.5 text-xs uppercase tracking-widest font-medium rounded-full border border-neutral-700 dark:border-neutral-700 light:border-neutral-300 text-neutral-200 dark:text-neutral-200 light:text-neutral-800 hover:bg-neutral-800/60 dark:hover:bg-neutral-800/60 light:hover:bg-neutral-100 transition-all"
            >
      ...
      <section className="py-20 border-t border-neutral-800/60 dark:border-neutral-800/60 light:border-neutral-200 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreServices.map((service) => (
            <div
              key={service.id}
              className="p-6 rounded-xl border border-neutral-800/80 dark:border-neutral-800/80 light:border-neutral-200 bg-neutral-900/40 dark:bg-neutral-900/40 light:bg-white flex flex-col justify-between space-y-6 hover:border-neutral-700 transition-colors"
            >
      ...
      {/* 4. EDITORIAL BIOGRAPHY & PORTRAIT */}
      <section className="py-20 border-t border-neutral-800/60 dark:border-neutral-800/60 light:border-neutral-200 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              ...
              <Link
                to="/cv"
                className="inline-flex items-center gap-2 px-5 py-2.5 text-xs uppercase tracking-widest font-medium rounded-full border border-neutral-700 text-neutral-300 hover:text-white transition-colors"
              >
        ...
        <section className="py-20 border-t border-neutral-800/60 dark:border-neutral-800/60 light:border-neutral-200 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {settings.testimonials.map((t) => (
              <div
                key={t.id}
                className="p-8 rounded-xl border border-neutral-800/80 dark:border-neutral-800/80 light:border-neutral-200 bg-neutral-900/20 dark:bg-neutral-900/20 light:bg-white space-y-6 flex flex-col justify-between"
              >
