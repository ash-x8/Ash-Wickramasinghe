...
import { submitContactMessage, getSiteSettings } from '../lib/firebase';
            ...
            {success ? (
              <div className="py-12 text-center space-y-4 font-mono">
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2.5 bg-[#00f0ff] text-[#0b0f19] font-bold text-xs uppercase tracking-wider rounded hover:bg-[#00f0ff]/90 transition-all"
                >
